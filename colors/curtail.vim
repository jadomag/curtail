...
" Author: Jack Magnus <curtail@xcvrt.com>
" Source: https://github.com/xcvrt/curtail
...
call s:Hl('PreProc', s:co5, s:none)
...
call s:Li('xmlEntity', 'Statement')
call s:Li('xmlEntityPunct', 'xmlEntity')
